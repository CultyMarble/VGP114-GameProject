...
{
    public static Enemy Spawn(Vector3 positition)
    {
        Transform pfEnemy = Resources.Load<Transform>("ZombiePlaceholder");
        Transform enemyTransform = Instantiate(pfEnemy, positition, Quaternion.identity);
